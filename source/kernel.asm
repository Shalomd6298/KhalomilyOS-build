; ==================================================================
; KhalomilyOS -- The Mike Operating System kernel
; Copyright (C) 2006 - 2022 KhalomilyOS Developers -- see doc/LICENSE.TXT
;
...
; use a KhalomilyOS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as KhalomilyOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to KhalomilyOS', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Thanks for trying out KhalomilyOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute KhalomilyOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of KhalomilyOS, and', 0
